...
},{"./utils/ajax_articles":3,"./utils/animations":4,"./utils/cover":5,"./utils/messenger":6,"./utils/scroller":7}],3:[function(require,module,exports){
'use strict';

var load_section = document.querySelector('#LoadSection');
var load_container = document.querySelector('#LoadContainer');
var load_button = document.querySelector('#LoadButton');

if (load_section && load_container && load_button) {
  var max_pages = load_button.dataset.maxpages;
  var max_articles = load_button.dataset.maxarticles;
  var paged = 1;
  ...
  load_button.addEventListener('click', function () {
    ...
    fetch('/wp-admin/admin-ajax.php', {
      ...
      var elements = Array.from(response.body.querySelectorAll('.ArticleCard'));
...
},{"aos":1}],5:[function(require,module,exports){
'use strict';
...
if (header && main) {
  ...
  var ratioHeight = header.offsetHeight / window.innerHeight;
  var offsetScreen = main.offsetTop;
